...
public class Transaction {
    ...
    public class Output {
        ...
        /**
         * value in bit coins of the output
         */
        public double value;
        /**
    ...
    /**
     * create a coin base transaction of value {@code coin} and calls finalize
     * on it
     *
     * @param coin
     * @param address
    ...
    public int hashCode() {
        int hash_value = 1;
        for (int i = 0; i < numInputs(); i++) {
            hash_value = hash_value * 31 + getInput(i).hashCode();
        }
        for (int i = 0; i < numOutputs(); i++) {
            hash_value = hash_value * 31 + getOutput(i).hashCode();
        }
        return hash_value;
    }
}
